...
const States = () => {
    return (
        <div className='bg-linear-to-r from-[#632EE3] to-[#9F62F2] p-16'>
            ...
            <div className='text-gray-200 grid lg:grid-cols-3  mt-10'>

                <div className='text-center'>
                    <h1>Total Downloads</h1>
                    <p className='text-7xl font-bold lg:mt-2'>29.6M</p>
                    <p className='mt-2'>21% more than last month</p>
                </div>
                <div className='text-center mt-7 lg:mt-0'>
                    <h1>Total Reviews</h1>
                    <p className='text-7xl font-bold lg:mt-2'>906K</p>
                    <p className='mt-2'>46% more than last month</p>
                </div>

                <div className='text-center mt-7 lg:mt-0'>
                    <h1>Active Apps</h1>
                    <p className='text-7xl font-bold lg:mt-2'>132+</p>
