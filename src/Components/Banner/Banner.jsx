    ...
    return (
        <div className='mt-10'>
            ...
            <div className='flex justify-center items-center gap-3 mt-5'>
                <a href="https://play.google.com/store/games?hl=en" target='_blank' className='flex items-center gap-2 border-2 border-[#D2D2D2] p-2 rounded-xl'>
                    <img src={playStoreIcon} alt="" className='w-7 h-7' />
                    <span className="text-xl text-black">Google Play</span>
                </a>

                <a href="https://www.apple.com/app-store/" target='_blank' className='flex items-center gap-2 border-2 border-[#D2D2D2] p-2 rounded-xl'>
                    <img src={appStoreIcon} alt="" className='w-7 h-7' />
                    <span className="text-xl text-black">App Store</span>
                </a>
